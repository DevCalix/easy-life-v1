...
const TopVendeurSection = ({ topVendeurs, appUrl }) => {
    return (
        <div className="container-fluid my-2">
            {topVendeurs.map((section) => (
                                ...
                                >
                                    <div className="card h-100 border-0 shadow-sm hover-shadow transition-all">
                                        ...
                                        <div className="card-body">
                                            <h6 className="card-title text-dark">{item.nom}</h6>
                                            {item.description && (
...
export default TopVendeurSection;
