...
import "../../../css/hotelReservation/HotelFooter.css";
...
const HotelFooter = () => {
  return (
    <footer
      ...
      style={{
        background: "linear-gradient(135deg, #6426A2, #003d82)", // Bleu pour l'hôtellerie
      }}
    >
        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            ...
            <p className="text-light">
              Easy Life simplifie la réservation d'hôtels en vous offrant un accès rapide
              aux meilleures offres d'hébergement adaptées à votre budget et à vos besoins.
            </p>
          </div>
          ...
          <div className="col-md-4 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a href={route('accueil.pharmacie')} className="text-light text-decoration-none">
                  Pharmacie
                </a>
              </li>
              <li>
                <a href={route('supermarche.accueil')} className="text-light text-decoration-none">
                  Supermarché
                </a>
              </li>
              <li>
                <a href={route('accueil.restaurant')} className="text-light text-decoration-none">
                  Commande de Repas
                </a>
              </li>
            </ul>
