...
import { Link } from "@inertiajs/inertia-react"; // Importez Link depuis Inertia
  ...
  return (
    <div className="container my-2 position-relative montserrat" id="pharmacie-proche">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h6 className="fw-bold mb-4">Pharmacies Proches</h6>
        <a href="/pharmacie-sante/pharmacies-proches" className="btn btn-outline-success btn-sm fs-6">
          Voir tout
        </a>
      </div>
      <hr/>
      ...
      >
        {pharmacies.map((pharmacie, index) => (
          ...
          >
            <Link href={`/pharmacie-sante/info-pharmacies/${pharmacie.id}`}>
              <img
                ...
                style={{
                  height: "200px",
                  objectFit: "cover",
                  cursor: "pointer", // Ajoutez un curseur pointer pour indiquer que l'image est cliquable
                }}
              />
            </Link>
