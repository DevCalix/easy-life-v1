...
const RestaurantIndex = ({ restaurants }) => {
    ...
    const handleDelete = (restaurantId) => {
        if (confirm('Êtes-vous sûr de vouloir supprimer ce restaurant ?')) {
            ...
            Inertia.delete(route('restaurant.destroy', restaurantId));
        }
    };
                        ...
                        <tbody>
                            {restaurants.map((restaurant, index) => (
                                <tr key={restaurant.id}>
                                    ...
                                    <td>
                                        <Link
                                            href={`/commande-repas/restaurant/${restaurant.id}/edit`}
                                        ...
                                        <Link
                                            ...
                                            href={`/commande-repas/restaurants/${restaurant.id}/informations-supplementaires/create`}
