...
const MetaCreate = ({ restaurant }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('restaurants.informations-supplementaires.restaurant', restaurant.id), {
            onSuccess: () => {
        ...
        <>
            ...
            <div className="container py-5">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <Link href={route('restaurant.index')} className="btn btn-primary montserrat-normal">
                        Retour
                    </Link>
                </div>
                        ...
                        <ul className="list-group">
                            {restaurant.metas.map((meta, index) => (
                                <li key={index} className="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <Link
                                        href={route('restaurants.informations-supplementaires.destroy', [restaurant.id, meta.id])}
                                        method="delete"
                                        as="button"
