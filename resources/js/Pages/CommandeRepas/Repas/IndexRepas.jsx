...
const IndexRepas = () => {
    ...
    const handleDelete = (id) => {
        if (confirm("Voulez-vous vraiment supprimer ce repas ?")) {
            Inertia.delete(route('repas.destroy', id), {
                preserveScroll: true,
            });
        }
    };
                                ...
                                <tr key={repas.id}>
                                    ...
                                    <td>
                                        <div className="d-flex gap-2">
                                            <Link
                                                href={`/commande-repas/repas/${repas.id}/edit`}
                                            ...
                                            <Link
                                                href={`/commande-repas/repas/${repas.id}/images-secondaires/create`}
                                                className="btn btn-info btn-sm"
                                            >
                                                Images
                                            </Link>
                                            <Link
                                                href={`/commande-repas/repas/${repas.id}/variations/create`}
