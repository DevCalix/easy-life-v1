...
const ChambreImages = ({ chambre }) => {
    ...
    const handleUpdateImagePrincipale = (e) => {
        e.preventDefault();
        post(`/reservation-hotel/chambres/${chambre.id}/update-image-principale`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAddImagesSecondaires = (e) => {
        e.preventDefault();
        post(`/reservation-hotel/chambres/${chambre.id}/add-image-secondaire`, {
            preserveScroll: true,
            onSuccess: () => {
            ...
            <div className="container py-5">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button
                        ...
                        onClick={() => Inertia.visit(route('chambres.index'))}
                    >
                        Retour
                    </button>
                </div>
                            ...
                            {chambre.images.map((image) => (
                                <div key={image.id} className="col-md-3 mb-3">
                                    ...
                                    <button
                                        ...
                                        onClick={() => router.delete(`/reservation-hotel/chambres/images/${image.id}`)}
                                    >
                                        Supprimer
                                    </button>
                                </div>
