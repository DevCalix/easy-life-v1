...
const MetaCreate = ({ store }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('stores.informations-supplementaires.store', store.id), {
            onSuccess: () => {
        ...
        <>
            ...
            <div className="container py-5">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <Link href={route('stores.index')} className="btn btn-primary montserrat-normal">
                        Retour
                    </Link>
                </div>
                        ...
                        <ul className="list-group">
                            {store.metas.map((meta, index) => (
                                <li key={index} className="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <Link
                                        href={route('stores.informations-supplementaires.destroy', [store.id, meta.id])}
                                        method="delete"
                                        as="button"
