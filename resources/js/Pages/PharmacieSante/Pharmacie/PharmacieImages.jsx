...
const PharmacieImages = ({ pharmacie }) => {
    ...
    const handleUpdateImagePrincipale = (e) => {
        e.preventDefault();
        post(`/pharmacie-sante/pharmacies/${pharmacie.id}/update-image-principale`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAddImagesSecondaires = (e) => {
        e.preventDefault();
        post(`/pharmacie-sante/pharmacies/${pharmacie.id}/add-image-secondaire`, {
            preserveScroll: true,
            onSuccess: () => {
                            ...
                            {pharmacie.images.map((image) => (
                                <div key={image.id} className="col-md-3 mb-3">
                                    ...
                                    <button
                                        ...
                                        onClick={() => router.delete(`/pharmacie-sante/pharmacies/images/${image.id}`)}
                                    >
                                        Supprimer
                                    </button>
                                </div>
