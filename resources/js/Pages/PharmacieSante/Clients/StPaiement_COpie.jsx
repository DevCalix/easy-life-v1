    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const data = {
                ...
                transaction_reason: "Achat de médicaments",
    ...
    const checkTransactionStatus = async (transaction_ref) => {
        try {
            const response = await axios.get(
                `https://my-coolpay.com/api/23b12b2c-0274-4556-b1e8-39e21b9830b0/transaction-status/${transaction_ref}`
            );
            ...
            if (status === "SUCCESS") {
                ...
                throw new Error("La transaction n'a pas été confirmée.");
            }
        } catch (error) {
    ...
    return (
        <>
            ...
            <div className="container py-5">
                <h1 className="text-center mb-4 fw-bold">Paiement du panier</h1>

                <div className="card shadow-sm p-4">
                    <div className="mb-3">
                        <h5 className="fw-bold">Montant total du panier :</h5>
                        <h4 className="text-primary fw-bold">{totalPanier.toLocaleString()} XAF</h4>
                    </div>
