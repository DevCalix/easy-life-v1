...
const PharmaciesDeGarde = ({ pharmaciesDeGarde = [] }) => {
    return (
        <>
            <Head title="Pharmacies de Garde" />
            <PharmaNavbar />
            <div className="container my-4 montserrat-normal">
                <h1 className="fw-bold mb-3 montserrat-normal">Pharmacies de Garde</h1>
                <hr />

                {/* Liste des pharmacies de garde */}
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    {pharmaciesDeGarde.map((pharmacie, index) => (
...
export default PharmaciesDeGarde;
