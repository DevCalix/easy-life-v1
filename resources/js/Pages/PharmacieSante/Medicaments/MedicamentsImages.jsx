...
const MedicamentsImages = ({ medicament }) => {
    ...
    const handleUpdateImagePrincipale = (e) => {
        e.preventDefault();
        post(`/pharmacie-sante/medicaments/${medicament.id}/update-image-principale`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAddImagesSecondaires = (e) => {
        e.preventDefault();
        post(`/pharmacie-sante/medicaments/${medicament.id}/add-image-secondaire`, {
            preserveScroll: true,
            onSuccess: () => {
            ...
            <div className="container py-5">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button
                        ...
                        onClick={() => Inertia.visit(route('medicaments.index'))}
                    >
                        Retour
                    </button>
                </div>
