...
const HopitalsImages = ({ hopital }) => {
    ...
    const [imagePreview, setImagePreview] = useState(hopital.image_principale_url);
    ...
    const handleUpdateImagePrincipale = (e) => {
        e.preventDefault();
        post(`/pharmacie-sante/hopitaux/${hopital.id}/update-image-principale`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAddImagesSecondaires = (e) => {
        e.preventDefault();
        post(`/pharmacie-sante/hopitaux/${hopital.id}/add-image-secondaire`, {
            preserveScroll: true,
            onSuccess: () => {
            ...
            <div className="container py-5">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button
                        ...
                        onClick={() => Inertia.visit(route('hopitaux.index'))}
                    >
                        Retour
                    </button>
                </div>
                ...
                <div className="card shadow p-4 mb-4">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <img src={hopital.image_principale} alt="Image secondaire" className="img-thumbnail" />
                        </div>
