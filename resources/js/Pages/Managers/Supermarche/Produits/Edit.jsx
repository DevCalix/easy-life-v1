...
const Edit = ({ produit }) => {
    ...
    const fetchStores = async () => {
        try {
            const response = await axios.get('/supermarche/managers/mds-magasins');
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/supermarche/managers/mds-produits/${produit.id}`);
    };

    return (
        <SupermarketLayout title={"Modifier le Produit"}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-3">
                        ...
                        <div className="btn-group" role="group" aria-label="Actions supplémentaires">
                            <Link
                                href={`/supermarche/managers/mds-produits/${produit.id}/edit-image`}
                                className="btn btn-warning"
                            >
                                Modifier l'image principale
                            </Link>
                            <Link
                                href={`/supermarche/managers/mds-produits/${produit.id}/ajouter-images`}
                                className="btn btn-warning"
                            >
                            ...
                            {produit.is_variable && (
                                <Link
                                    href={`/supermarche/managers/produits/${produit.id}/ajouter-variation`}
