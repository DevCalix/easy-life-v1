...
const ProductIndex = () => {
    ...
    const handleDelete = (id) => {
        if (confirm("Voulez-vous vraiment supprimer ce produit ?")) {
            Inertia.delete(route('mds-produits.destroy', id), {
                preserveScroll: true,
            });
        }
    };
    ...
    return (
        <SupermarketLayout title="Produits">
            
            <div className="container">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <h1 className='montserrat-normal fw-bold'>Liste des Produits</h1>
                    <Link href={route('mds-produits.create')} className="btn btn-primary">
                        Ajouter un Produit
                    </Link>
                </div>
                            ...
                            {filteredProduits.length > 0 ? (
                                filteredProduits.map((produit, index) => (
                                    <tr key={produit.id}>
                                        ...
                                        <td>
                                            <Link
                                                href={`/supermarche/managers/mds-produits/${produit.id}/edit`}
