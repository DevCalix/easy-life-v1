...
const EditCategorie = ({ categorie }) => {
    ...
    const handleGeneralSubmit = (e) => {
        e.preventDefault();
        updateGeneral(route('mgs-categorie-repas.update', categorie.id), {
            onSuccess: () => {
    ...
    const handleImageSubmit = (e) => {
        e.preventDefault();
        updateImage(route('mgs-categorie-repas.updateImage', categorie.id), {
            onSuccess: () => {
    ...
    return (
        <RestauLayout title="Modifier une Catégorie">
