...
const AddVariationRepas = ({ repas, variations }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('mgs-repas.variations.store', { repas: repas.repasId }), {
            onSuccess: () => {
    ...
    const handleDelete = (variationId) => {
        if (confirm("Voulez-vous vraiment supprimer cette variation ?")) {
            router.delete(route('mgs-repas.variations.destroy', { repas: repas.repasId, variation: variationId }), {
                onSuccess: () => {
    ...
    return (
        <RestauLayout title="Ajouter une Variation">

            <div className="container-fluid">
                {/* Bouton de retour */}
                <div className="my-4">
                    <Link href={route('mgs-repas.index')} className="btn btn-secondary">
                        Retour
                    </Link>
                </div>
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <form onSubmit={handleSubmit} className="p-4 bg-light border rounded-3 shadow-sm mb-4">
                            {/* Titre */}
                            <h2 className="mb-4 text-center text-primary h6 fw-bold">Ajouter une Variation</h2>
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="p-4 bg-light border rounded-3 shadow-sm">
                            <h2 className="mb-4 text-center text-primary h6 fw-bold">Variations existantes</h2>
                            {variations.length > 0 ? (
