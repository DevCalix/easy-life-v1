...
const CreateImagesSecondaires = ({ repas, imagesSecondaires = [] }) => {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('mgs-repas.images-secondaires.store', repas.id), {
            data: formData,
            onSuccess: () => {
    ...
    const handleDelete = (imageId) => {
        if (confirm("Voulez-vous vraiment supprimer cette image ?")) {
            router.delete(route('mgs-repas.images-secondaires.destroy', { repas: repas.id, image: imageId }), {
                onSuccess: () => {
    ...
    return (
        <RestauLayout title="Ajouter des Images Secondaires">
