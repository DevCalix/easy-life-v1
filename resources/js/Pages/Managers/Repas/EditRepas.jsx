...
const EditRepas = ({ repas, categories, restaurants, tags: initialTags }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/managers/mgs-repas/${repas.repasId}`, {
            onSuccess: () => {
    ...
    const handleUpdateImage = (e) => {
        e.preventDefault();
        updateImage(route('mgs-repas.updateImage', repas.repasId), {
            onSuccess: () => {
    ...
    return (
        <RestauLayout title="Modifier le Repas">
            
            <div className="container">
                <h1 className="mb-4 h5 fw-bold">Modifier un Repas</h1>
                ...
                <div className="card">
                    <div className="card-header">
                        <h2 className="h6 fw-bold">Mise à jour de l'image</h2>
                    </div>
                    <div className="card-body">
