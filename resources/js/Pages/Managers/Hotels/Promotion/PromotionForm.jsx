...
const PromotionForm = ({ hotels, chambres, promotion = null }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (promotion) {
            ...
            put(`/hotel/managers/mgs-promotions/${promotion.id}`, {
                onSuccess: () => router.visit('/hotel/managers/mgs-promotions'),
            });
        } else {
            // Créer une nouvelle promotion
            post('/hotel/managers/mgs-promotions', {
                onSuccess: () => router.visit('/hotel/managers/mgs-promotions'),
            });
        }
    };
    ...
    return (
        <HotelsLayout title={promotion ? "Modifier une Promotion" : "Ajouter une Promotion"}>
            ...
            <div className="container-fluid">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <Link href={route('mgs-promotions.index')} className="btn btn-primary montserrat-normal">
                        Retour
                    </Link>
                </div>
                            ...
                            <div className="row gy-4">
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <SelectInput
                                        ...
                                        name="ht_hotel_id"
                                        options={[
                                            { value: '', label: 'Choisir un hôtel' }, // option vide par défaut
                                            ...hotels.map((hotel) => ({
                                                value: hotel.id,
                                                label: hotel.nom,
                                            })),
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <SelectInput
                                        ...
                                        name="ht_chambre_id"
                                        options={[
                                            { value: '', label: 'Choisir une chambre' }, // valeur par défaut
