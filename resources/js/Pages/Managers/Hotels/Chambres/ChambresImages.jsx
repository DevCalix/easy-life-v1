...
const ChambreImages = ({ chambre }) => {
    ...
    const [imagePreview, setImagePreview] = useState(chambre.image_principale_url);
    ...
    const handleUpdateImagePrincipale = (e) => {
        e.preventDefault();
        post(`/hotel/managers/chambres/${chambre.id}/update-image-principale`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAddImagesSecondaires = (e) => {
        e.preventDefault();
        post(`/hotel/managers/chambres/${chambre.id}/add-image-secondaire`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <HotelsLayout title={"Gestion des Images de l'Hôtel"} >
            ...
            <div className="container py-5">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button
                        ...
                        onClick={() => Inertia.visit(route('mgs-chambres.index'))}
                    >
                        Retour
                    </button>
                </div>
                ...
                <div className="card shadow p-4 mb-4">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <img src={chambre.image_principale} alt="Image secondaire" className="img-thumbnail" />
                        </div>
                ...
                <div className="card shadow p-4">
                    <h5 className="mb-4 montserrat-normal fw-bold">Images Secondaires</h5>
