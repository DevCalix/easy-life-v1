...
const CreateChambre = ({ hotels }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post('/hotel/managers/mgs-chambres', {
            onSuccess: () => router.visit('/hotel/managers/mgs-chambres'),
            onError: (errors) => console.error('Erreur lors de la soumission :', errors),
        });
    };

    return (
        <HotelsLayout title="Ajouter une Chambre">
            <div className="container-fluid">
                <div className="d-flex justify-content-between align-items-center mb-2">
                    <h1 className="mb-4 montserrat-normal fw-bold text-primary">Ajouter une Chambre</h1>
                    <Link href={route('mgs-chambres.index')} className="btn btn-primary montserrat-normal">
                        retour
                    </Link>
                </div>
