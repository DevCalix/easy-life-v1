...
const IndexChambre = () => {
    ...
    return (
        <HotelsLayout title="Liste des Chambres">

            <div className="container">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <h1 className="montserrat-normal fw-bold">Liste des Chambres</h1>
                    <Link href={route('mgs-chambres.create')} className="btn btn-primary montserrat-normal">
                        Ajouter une Chambre
                    </Link>
                </div>
                                    ...
                                    <tr key={chambre.id}>
                                        ...
                                        <td>
                                            <div className="d-flex gap-2">
                                                {/* Bouton Éditer */}
                                                <Link
                                                    href={route('mgs-chambres.edit', chambre.id)}
                                                ...
                                                {/* Gérer les images */}
                                                <Link
                                                    href={`/hotel/managers/chambres/${chambre.id}/images`}
