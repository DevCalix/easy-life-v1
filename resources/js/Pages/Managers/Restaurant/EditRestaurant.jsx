...
const EditRestaurant = ({ restaurant }) => {
    ...
    const handleGeneralSubmit = (e) => {
        e.preventDefault();
        updateGeneral(route('mgs-restaurant.update', restaurant.random_id), {
    ...
    const handleImageSubmit = (e) => {
        e.preventDefault();
        updateImage(route('mgs-restaurant.updateImage', restaurant.id), {
            onSuccess: () => {
    ...
    return (
        <RestauLayout title="Modifier le Restaurant">
