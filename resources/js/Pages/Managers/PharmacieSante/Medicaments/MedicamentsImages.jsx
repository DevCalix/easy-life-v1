...
const MedicamentsImages = ({ medicament }) => {
    ...
    const [imagePreview, setImagePreview] = useState(medicament.image_principale_url);
    ...
    const handleUpdateImagePrincipale = (e) => {
        e.preventDefault();
        post(`/managers/medicaments/${medicament.id}/update-image-principale`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAddImagesSecondaires = (e) => {
        e.preventDefault();
        post(`/managers/medicaments/${medicament.id}/add-image-secondaire`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <PharmaLayout title="Gestion des Images">
            <div className="container-fluid">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button
                        ...
                        onClick={() => Inertia.visit(route('sts-medicaments.index'))}
                    >
                        Retour
                    </button>
                </div>
                ...
                <div className="card shadow p-4 mb-4">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <img src={medicament.image_principale} alt="Image secondaire" className="img-thumbnail" />
                        </div>
...
export default MedicamentsImages;
