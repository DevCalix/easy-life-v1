...
const PharmacieImages = ({ pharmacie }) => {
    ...
    const [imagePreview, setImagePreview] = useState(pharmacie.image_principale_url);
    ...
    const handleUpdateImagePrincipale = (e) => {
        e.preventDefault();
        post(`/managers/pharmacies/${pharmacie.id}/update-image-principale`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAddImagesSecondaires = (e) => {
        e.preventDefault();
        post(`/managers/pharmacies/${pharmacie.id}/add-image-secondaire`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <PharmaLayout title="Gestion des Images de la Pharmacie">
            ...
            <div className="container py-5">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button
                        ...
                        onClick={() => Inertia.visit(route('pharmacie.index'))}
                    >
                        Retour
                    </button>
                </div>
                ...
                <div className="card shadow p-4 mb-4">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <img src={pharmacie.image_principale} alt="Image secondaire" className="img-thumbnail" />
                        </div>
...
export default PharmacieImages;
