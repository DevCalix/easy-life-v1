...
class StoreHtChambreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'string',
            'max:255',
                Rule::unique('ht_chambres', 'numero_chambre')
                    ->where(function ($query) {
                        return $query->where('ht_hotel_id', request()->ht_hotel_id);
                    }),
    ...
    public function messages(): array
    {
        return [
            ...
            'numero_chambre.unique' => 'Ce numéro de chambre est déjà utilisé pour cet hôtel.',
