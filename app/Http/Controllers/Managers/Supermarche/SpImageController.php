...
class SpImageController extends Controller
{
    public function showAddSecondaryImagesForm($id)
    {
        ...
        return Inertia::render('Managers/Supermarche/Produits/AddSecondaryImageForm', [
    ...
    public function storeImages(Request $request, $id)
    {
        ...
        return Inertia::location(route('mds-produits.ajouter-images', $produit->id));
    }
