...
class RepasManagersController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return Inertia::render('Managers/Repas/CreateRepas', [
    ...
    public function store(StoreRepasRequest $request)
    {
        ...
        return redirect()->route('mgs-repas.index')->with('success', 'Repas créé avec succès.');
    }
     ...
     */
    public function edit(string $repasId)
    {
        $repas = Repas::with(['categorie', 'tags', 'restaurant'])->where('repasId', $repasId)->firstOrFail();
        $categories = CategorieRepas::all();
        ...
        return Inertia::render('Managers/Repas/EditRepas', [
            'repas' => $repas,
            'categories' => $categories,
            'restaurants' => $restaurants,
            'tags' => $tags,
     ...
     */
    public function update(StoreRepasRequest $request, string $repasId)
    {
        ...
        return redirect()->route('mgs-repas.index')->with('success', 'Repas mis à jour avec succès.');
    }

    public function updateImage(Request $request, $repasId)
    {
        $repas = Repas::where('repasId', $repasId)->firstOrFail();
        ...
        return redirect()->route('mgs-repas.index')->with('success', 'Photo du repas mise à jour avec succès.');
     ...
     */
    public function destroy(string $repasId)
    {
        $repas = Repas::where('repasId', $repasId)->firstOrFail();
        ...
        // Rediriger avec un message de succès
        return redirect()->route('mgs-repas.index')->with('success', 'Repas supprimé avec succès.');
    }
}
