...
class HtGestionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return Inertia::render('Managers/Hotels/Hotels/IndexHotel', [
            'hotels' => $hotels,
        ]);
    }
    ...
    {
        return Inertia::render('Managers/Hotels/Hotels/CreateHotel');
    }
    ...
    public function store(StoreHtHotelRequest $request)
    {
        ...
        return redirect()->route('mgs-hotels.index')->with('success', 'Hôtel créé avec succès !');
    }
    ...
    public function edit(string $id)
    {
        ...
        return Inertia::render('Managers/Hotels/Hotels/EditHotel', [
            'hotel' => $hotel,
        ]);
    }
    ...
    public function update(StoreHtHotelRequest $request, string $id)
    {
        ...
        // Redirection avec un message de succès
        return redirect()->route('mgs-hotels.index')->with('success', 'Hôtel mis à jour avec succès !');
    }
    ...
    public function showImages(string $id)
    {
        ...
        return Inertia::render('Managers/Hotels/Hotels/HotelImages', [
            'hotel' => $hotel,
        ]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        // Rediriger avec un message de succès
        return redirect()->route('mgs-hotels.index')->with('success', 'Hôtel supprimé avec succès !');
    }
}
