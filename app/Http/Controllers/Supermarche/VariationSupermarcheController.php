...
class VariationSupermarcheController extends Controller
{
    /**
     ...
     */
    public function store(VariationImageRequest $request, Produit $produit)
{
    try {
        // Valider les données
    ...
    public function show(Produit $produit)
    {
        ...
        return Inertia::render('Supermarche/Produits/AddVariationsForm', [
